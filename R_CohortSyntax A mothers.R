...
setwd("./results") #set to the working directory of Esther/Tom
...
Data$AntidepMed <- as.factor(Data$t5404)
...
Data$ModPhyAct <- Data$t3028
Data$WalPhyAct <- Data$t3029

# Hours per week spent doing any type of physical activity
# EW: fixed to accept missing data for either one variable
Data$PhyAct <- ifelse(!(is.na(Data$ModPhyAct & is.na(Data$WalPhyAct))), rowSums(cbind(Data$ModPhyAct, Data$WalPhyAct), na.rm=T), NA)

#number of cigarettes smoked in a day
# EW: SPSS coding for t5566 missleading; missing for this variables needs to be set to range: -9999 to -10 and -1, but exclude -2 (=never smoked)
# EW: also, check with TW re 2 typos?
#Data$Smoke <- revalue(ifelse(Data$t5566 == -2, 0, ifelse(data$t5566 > 0, 1, NA)))
Data$Smoke <- ifelse(Data$t5566 == -2, 0, ifelse(Data$t5566 > 0, 1, NA))

#amonut of alcohol mum drinks
# EW: what's this coding? ask TW; I recorded this 'as.numeric' (and not 'as.factor')
Data$Alcohol <- as.numeric(ifelse(Data$k6190 == 1, 0, 
...
# EW: alcohol coding doesn't make sense? done 'as.numeric' now (see above)
...
write.csv(SampleA_Characteristics,"ALSPAC.mums_descriptives_20210325.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date


# 5.4. Sample B
# EW: wrong code, edited
...
##QUESTION CAMILLE ### Can you explain this function?  LOGIT? (#EW: tbd)
...
write.csv(Stats_model1,"ALSPAC.mums_MODEL1_20210325.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model2,"ALSPAC.mums_MODEL2_20210325.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model3,"ALSPAC.mums_MODEL3_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
# EW: error for alchol and physAc! I assume that's okay, as these variables are actually not part of model 4

# 9.3. Export dataframe of summary statistics of model #4 into a csv file 
write.csv(Stats_model4,"ALSPAC.mums_MODEL4_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
# EW: same alc / phys error as above
...
write.csv(Stats_model5,"ALSPAC.mums_MODEL5_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model6,"ALSPAC.mums_MODEL6_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model7,"ALSPAC.mums_MODEL7_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model8,"ALSPAC.mums_MODEL8_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model9,"ALSPAC.mums_MODEL9_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date



# EW: all commented out, as we don't have men
...
# write.csv(Stats_model10,"NA.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date


# EW: same as SampleB scripts?
...
write.csv(Stats_model11,"ALSPAC.mums_MODEL11_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model12,"ALSPAC.mums_MODEL12_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model13,"ALSPAC.mums_MODEL13_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model14,"ALSPAC.mums_MODEL14_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model15,"ALSPAC.mums_MODEL15_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
...
write.csv(Stats_model16,"ALSPAC.mums_MODEL16_20210326.csv", row.names = TRUE)  #Change path to working directory on your computer and re-name file with cohort's name and date
