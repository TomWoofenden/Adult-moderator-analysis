...
setwd("~/Documents/VUmc/NESDA/Studies/MetS/Datasets")
...
#here added varibale not inlucded in Camilles plan, as this was blank for partners
Data$CVD2 <- CVD1

#Come back to ask Camille about coding on this part
Data$CVDMed <- CD
...
Data$PhyAct <- rowSums(cbind(Data$VigPhyAct, Data$ModPhyAct, Data$WalPhyAct))

Data$Smoke <- (((ifelse(Data$pq1300 < 0, NA)*5)) + ((ifelse(Data$pq1301 < 0, NA)*2))/7)


Data$Alcohol <- as.factor(ifelse(Data$ph6190 == 1, 0, 
